    ...
    return <Container>
        <Card className="text-light modal-header">
            <Card.Body className="h-200">
                ...
                <Row>
                    <SingleCourt name="Mokyklos aisktele" url="https://picsum.photos/400/400?random=1" status="Uzklausa issiusta" >
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sint et rem facilis deleniti ipsum nulla.
                    </SingleCourt>
                    <SingleCourt name="Nemuno salos kortas" url="https://picsum.photos/400/400?random=2" status="Aktyvus" >
                        Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sint et rem facilis deleniti ipsum nulla.
                    </SingleCourt>
                </Row>
            </Card.Body>
